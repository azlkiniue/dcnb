...
// FindAutoNamedContainers returns the names of containers with autogenerated names.
func FindAutoNamedContainers(ctx context.Context, cli DockerClient) ([]container.Summary, error) {
