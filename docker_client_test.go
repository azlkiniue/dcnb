...
func TestCleanAutoGeneratedContainersRemovesMatches(t *testing.T) {
	...
	removed, err := CleanAutoGeneratedContainers(ctx, mock)
	if err != nil {
...
func TestCleanAutoGeneratedContainersAggregatesErrors(t *testing.T) {
	ctx := context.Background()
	mock := &mockDockerClient{
		containers: []container.Summary{
			{ID: "id1", Names: []string{"/inspiring_franklin"}},
